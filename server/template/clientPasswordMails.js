...
exports.forgetPasswordContent = (userData, authToken,companyId) => ({
  ...
  html: `<p>Hi <strong> ${getUserName(userData)} </strong>,<br>
      ...
      Link: <a href='${process.env.HOST_ORIGIN_URL}/reset-password/${authToken}'> click to reset your account</a><br />
