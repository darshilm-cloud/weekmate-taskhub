...
`
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td valign="meddile" style="color: #333; font-weight: 200; font-size: 16px">
                        <b>${getUserName(
                          data?.createdBy
                        )}</b> has <b>assigned</b> you the bug:
                      </td>
                    </tr>
                  </tbody>
                </table>
      ...
      data?.estimated_minutes
            ...
            <tr>
              <td style="
                ...
                <b>${getUserName(
                  data?.createdBy
                )}</b> has <b>assigned</b> you the bug: <b>${data?.title} <i>(${
      data?.bugId
    })</i>
                </b>
                <br />
    ...
    let mailSettingsData = mailSettings.filter((ele) => ele.bug_assigned);
          ...
          <tbody>
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tbody>
                    <tr>
                      ...
                      <td valign="middle" align="left" width="100%" style="font-size:14px">
                      ${
                        data?.oldData?.task?.isPrivateList
                          ? `<img src='${privateIcon}' alt="private Icon" style="margin-right: 5px; vertical-align: middle" />`
                          : ""
                      }
                       ${
                         data?.oldData?.task?.title
                           ? data?.oldData?.task?.title
                           : " - "
                       }
                      </td>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td valign="meddile" style="color:#333;font-weight:200;font-size:16px">
                        <b>${getUserName(
                          data?.newData?.updatedBy
                        )}</b> has <b>changed the stage</b> of the bug:
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <tr>
              <td style="font-size:13px;padding:20px 10px 15px;line-height:130%;border-top:1px solid #dfe0e0;color:#a6a6a6">
                ...
                <b>${getUserName(
                  data?.newData?.updatedBy
                )}</b> has <b>changed the stage</b> of the bug: <b>${
      data?.oldData?.title
    } <i>(${data?.oldData?.bugId})</i>
                </b>
                <br>
