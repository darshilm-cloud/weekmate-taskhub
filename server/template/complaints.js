      ...
      let html = `
            <div style="font-family: Arial, sans-serif; color: #333;">
                ...
                <h3 style="color: #187cb7;">New Complaint Received</h3>
                    ...
                    <p>We have received the following complaint from <strong>${
                      data?.client_name
                    }</strong>.</p>
        ...
        data?.priority.slice(1).toLowerCase()
                  ...
                  <p>${
                    data?.manager?.full_name
                  }, please work on this complaint as per the <a href="${
        process.env.SOP_LINK
      }" style="color: #187cb7; text-decoration: underline;">SOP</a> and update the status in <a href="${
        process.env.REACT_URL + "add/complaintForm-action-details/" + data?._id
      }" style="color: #187cb7; text-decoration: underline;">TaskHub</a>.</p>
