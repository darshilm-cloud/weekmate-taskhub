...
<html lang="en">
  ...
  <body>
          ...
          <tbody>
                    ...
                    <tr>
                      <td valign="top" style="padding: 15px 0 0 0">
                        <div style=" width: 30px; margin-right: 20px; display: inline-block; height: 30px; vertical-align: top; border-radius: 50%; overflow: hidden; ">
                          ...
                          } alt="" width="40" height="40" style="border-radius: 50%; margin-right: 10px">
                        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td valign="meddile" style="color: #333; font-weight: 200; font-size: 16px">
                        <b>${getUserName(
                          data?.createdBy
                        )}</b> has <b>commented </b>on the note:
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <tr>
              <td style="
                ...
                <b>${getUserName(
                  data?.createdBy
                )}</b> has <b>commented</b> on the note: <b>${data?.task?.title}
                </b>
                <br />
              </td>
            </tr>
    ...
    let mails = [...data.taggedUsers.map((t) => t), data?.manager];

    // to get that taggedUsers and manager mailids whose mail setting for note_tagged_comments is true
