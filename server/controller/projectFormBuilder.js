...
const DEFAULT_PROJECT_FIELDS = [
  ...
  { key: "pms_clients", label: "Client Name", type: "multiselect", required: false, isDefault: true },
  ...
  { key: "acc_manager", label: "Account Manager", type: "select", required: false, isDefault: true },
