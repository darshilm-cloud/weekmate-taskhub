/**
 * Mount coverage for SuperAdminBillableHours.
...
// eslint-disable-next-line import/first
import Component from './SuperAdminBillableHours';

mountSmoke('SuperAdminBillableHours', Component, {
  Service,
  route: '/acme/billable-hours',
