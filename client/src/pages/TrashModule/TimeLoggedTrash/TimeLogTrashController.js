...
const TimeLogTrashController = () => {
  ...
  const getTimeLoggedTrash = async (callback) => {
    try {
      ...
      const response = await Service.makeAPICall({
        ...
        api_url: Service.trashLoggedTime,
        body: reqBody,
      });
  ...
  return { getTimeLoggedTrash, TimeLoggedTrashColumns };
};

export default TimeLogTrashController;
