        ...
        <div className="cad-info-body">
          ...
          <div className="cad-info-fields">
            <div className="cad-info-field">
              <div className="cad-info-label">Project</div>
              <div className="cad-info-value">{complaintsData?.project?.title || "—"}</div>
            </div>
            <div className="cad-info-field">
              <div className="cad-info-label">Client</div>
      ...
      <div className="cad-section">
        <div className="cad-section-header">
          ...
          {hasStatus && (
            isEdit
              ? (
                <Button className="delete-btn" onClick={() => setIsEdit(false)}>
                  Cancel
                </Button>
              ) : (
                <Button className="add-btn" onClick={() => setIsEdit(true)}>
                  <EditOutlined /> Edit
                </Button>
              )
          )}
          ...
          {hasStatus && !isEdit ? (
            <div className="cad-status-view">
              ...
              <div className="cad-status-field" style={{ gridColumn: "1 / -1" }}>
                ...
                <div className="cad-field-value highlight">{currentStatus.root_cause || "—"}</div>
              </div>
                ...
                {!isEditComment && (
                  <Form.Item name="document" label="Attachment">
                    <Upload
                      ...
                      beforeUpload={() => false}
                      maxCount={1}
                      onChange={({ fileList }) => setFileAttachment(fileList[0]?.originFileObj || null)}
                    >
