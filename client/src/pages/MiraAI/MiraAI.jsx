...
const MiraAI = () => {
    const predefinedPrompts = [
        ...
        "Get priority for this task: %%(task name)%%.",
        ...
        "Get all high-priority tasks for this project: %%(project name)%%.",
        "Get all medium-priority tasks for this project: %%(project name)%%.",
        "Get all low-priority tasks for this project: %%(project name)%%.",
        ...
        "Get all tasks sorted by priority for this project: %%(project name)%%.",
        ...
        "Get priority for this bug: %%(bug title/id)%%.",
        ...
        "Get all bugs with priority: Low.",
        "Get all bugs with priority: Medium.",
        "Get all bugs with priority: High.",
        "Get bug count for priority: %%(priority level)%%.",
        ...
        "Get all positive reviews from department: %%(department name)%%.",
